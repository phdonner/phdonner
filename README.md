...
When I started this README I received a lot of redundant images, which looked like emoji ;) symbols. It would, however, be nice to know where all these decorative characters are coming from: 😖 👋 👀 🌱 💞️ 📫 🌷 🌼 🌻. OK, they are provided by the Segoe UI Emoji font (cf. [Emoji Objects](https://emojipedia.org/objects) ), but why are the characters sometimes rendered with colors, and sometimes in black and white?
