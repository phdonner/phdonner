...
Planning is a conceptual activity. To be effective, we are trying to outline a structure which will guide our work. The next subheadings are a list of some of the topics and immediate tasks that we are facing right now.  
...
GitHub supports a convenient way of creating the mind maps needed during our planning. It is called *Mermaid*. You can design many diagram flavors: flow charts, sequence diagrams, Git Graphs etc.. Again, many of the mermaid notations are rather easy to learn. Study the markdown code behind the example diagram by copying it to text processor.
