...
Planning is a conceptual activity. To be effective, we are trying to outline a structure which will guide our work. The next subheadings are a list of some of the immediate tasks that we are facing right now.  
